...
void SetupRC()
{
	...
	GLfloat  diffuseLight[] = { 0.5f, 0.7f, 0.3f, 1.0f };
	GLfloat  specular[] = { 0.3f, 0.5f, 0.5f, 1.0f };
	GLfloat  specref[] = { 1.0f, 0.0f, 0.0f, 1.0f };   // add – specular 
	...
	glLightfv(GL_LIGHT0,GL_SPECULAR, specular);   // add – specular term 추가 
	glEnable(GL_LIGHT0);
	...
	glMateriali(GL_FRONT, GL_SHININESS, 48);	// add - specular 
